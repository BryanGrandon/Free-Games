...
const Modal = ({ content }: Modal) => {
  ...
  return (
    <article id='modal' onClick={(e) => closeModal(e)} className='fixed w-full h-full z-10 bg-[#000000a9] backdrop-blur-sm flex items-center justify-center'>
      <section className=' min-w-2/4 min-h-2/4 relative border-secondary border-2 border-solid rounded-2xl bg-[#000000de] shadow shadow-black p-4 pt-9'>
